...
const formatDate = (date) => {
    ...
    return date0.toISOString().slice(0, 10); // 提取日期部分
}
    ...
    <el-card class="page-container">
        ...
        <el-form inline class="searchform">
            ...
            <el-form-item>
                ...
                <el-button class="bottone5" @click="categoryId='请选择';initDraft(username)" style="color: rgba(0, 0, 0, 0.753);">重置</el-button>
            </el-form-item>
        </el-form>
                ...
                <div class="bg">
                    <div>
                        ...
                        <div class="card-footer">
                            ...
                            <el-button type="text" :icon="DocumentCopy" @click="goToQuestionnaireDesignCopy(questionnaire.SurveyID, questionnaire.Category, 1)" class="thebutton">复制问卷</el-button>
