<script setup>
    ...
    const login = () => {
        ...
        console.log("hello 2024.8.28 19:42")
        ...
        <el-container>
            ...
            <el-container class="login-container">
                ...
                <div :class = "isLogin === 1 ? 'card' : 'card active'">
                    ...
                    <div class="desc">欢迎来到“纸翼传问”！在这个简洁而美观的问卷平台上，你将发现一场关于数据的探索之旅。我们不仅为您提供功能齐全的问卷设计工具，更带您走进数据的世界，解析其中的奥秘。<br/><br/><br/>
                        · 我们以简约之美为设计理念，让您的问卷拥有引人注目的外观，让每一份问题都成为一道视觉盛宴。<br/><br/> 
                        · 数据是您的指南针，我们提供直观的数据分析和图表展示，助您驾驭信息的海洋，掌握事物的本质。<br/><br/> 
                    </div>
                    <div class="btn">
                        {{ isLogin === 1 ? "新用户 ?" : "已有账号 ？"}}
